...
// Envoi du mail
if(mail($from, $destinataire, $sujet, $message)) {
    echo ("Votre mail a été envoyé avec succès.");
}
else {
    echo ("Impossible d'envoyer l'email. Veuillez réessayer.");
}
*/

/*
$retour = mail("hortensere@aol.com", "Test", $_POST["message"], "From : webmaster@monsite.fr");
if ($retour) {
